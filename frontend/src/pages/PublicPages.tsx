    ...
    <section className="product-detail"><div className="container">
      <div className="product-detail__grid">
        ...
        <div className="product-summary">
          ...
          <h1>{productName} | {managed?.brand || companyConfig.name}</h1>
