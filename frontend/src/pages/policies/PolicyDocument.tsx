...
const policyContent: Record<PolicyKind, { eyebrow: string; title: string; subtitle: string; sections: PolicySection[] }> = {
  ...
  privacy: { eyebrow: 'Privacidade e proteção de dados', title: 'Política de Privacidade', subtitle: 'Apresentamos de forma transparente como tratamos dados de visitantes, clientes e contatos comerciais.', sections: [
    { title: 'Dados que podemos tratar', paragraphs: ['Coletamos informações relacionadas ao atendimento e à operação da loja quando necessárias para cadastro, faturamento, pagamento, entrega ou suporte.'], points: ['Cadastro: nome, sobrenome, e-mail e telefone.', 'Compra: CPF ou CNPJ, endereço, CEP e dados do pedido.', 'Navegação: endereço IP, cookies essenciais e informações técnicas do dispositivo.'] },
    { title: 'Como utilizamos os dados', paragraphs: ['Usamos os dados para atender solicitações, preparar propostas, processar pedidos, pagamentos e entregas, emitir documentos fiscais, prevenir fraudes e cumprir obrigações legais.'] },
    ...
    { title: 'Armazenamento e segurança', paragraphs: ['Adotamos controles técnicos e administrativos proporcionais aos riscos. Os dados são mantidos somente pelo período necessário à finalidade informada ou exigido por lei.'] },
