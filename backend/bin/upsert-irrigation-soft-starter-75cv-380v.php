...
$product = [
    ...
    'features' => json_encode([
        ...
        'Soft Starter SSW07 para motor de 75 CV em 380 V',
        'Bornes para acionamento remoto por contato seco',
    ], JSON_UNESCAPED_UNICODE | JSON_THROW_ON_ERROR),
    'benefits' => json_encode([
        'Partidas e paradas suaves com menor desgaste mecânico',
        'Redução dos picos de corrente na rede elétrica',
    ...
    'components' => json_encode([
        'Caixa metálica 80 × 60 × 30 cm',
        'Soft Starter SSW07 75 CV 380 V',
    ...
    'reference_code' => 'PAINEL-IRRI-SSW07-75CV-380V',
    ...
    'featured' => 0,
    'status' => 'published',
    'seo_title' => 'Painel para Irrigação Soft Starter SSW07 75CV 380V | Painel de Comando',
    'seo_description' => 'Painel de Comando para irrigação com Soft Starter SSW07, motor de até 75 CV em 380 V, IHM remota e proteção elétrica completa.',
];
...
fwrite(STDOUT, "Produto para irrigação 75 CV atualizado.\n");
