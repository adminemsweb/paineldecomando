...
$pdo = Connection::get();
$slug = 'painel-condominio-revezamento-bombas-3cv-220v-trifasico';
$product = [
    'name' => 'Painel para Condomínio Revezamento de Bombas 3CV 220V Trifásico',
    'slug' => $slug,
    'summary' => 'Painel IP55 para alternância automática de duas bombas de 3 CV em 220 V trifásico, com acionamento manual ou automático por boia.',
    'description' => "O Painel para Condomínio Revezamento de Bombas 3CV 220V Trifásico foi projetado para controlar duas motobombas em condomínios, indústrias e clubes. O revezamento distribui o tempo de funcionamento entre os motores, reduz o desgaste concentrado em uma única unidade e mantém uma bomba reserva disponível para continuidade do abastecimento.\n\nO acionamento pode ser realizado manualmente pela chave seletora de três posições ou automaticamente por sinal de boia. A lógica de alternância equilibra o uso do conjunto, facilita a manutenção preventiva e contribui para uma operação mais eficiente do sistema de bombeamento.\n\nO painel utiliza proteção individual contra sobrecarga e monitoramento de falta de fase. O gabinete metálico IP55 oferece proteção contra poeira e umidade, enquanto a sinalização frontal permite acompanhar o comando, o funcionamento de cada motor e alertas de falha.\n\nATENÇÃO: equipamento trifásico. As imagens são meramente ilustrativas; considere as especificações desta página. Os botões da porta e do quadro de comando são enviados desmontados para evitar avarias durante o transporte. O engate dos contatos utiliza flanges de encaixe rápido, permitindo montagem e remoção sem ferramentas, com simples aperto manual.\n\nInstalação e uso técnico: o equipamento deve ser instalado e manuseado por profissionais qualificados ou com conhecimento técnico adequado. Isso garante o pleno desempenho do produto e a segurança da aplicação. Dúvidas específicas de instalação devem ser direcionadas a um profissional habilitado da área elétrica.",
    ...
    'benefits' => json_encode([
        'Uso equilibrado das bombas para maior eficiência operacional',
    ...
    'components' => json_encode([
        ...
        'Dois contatores industriais dimensionados para 3 CV',
    ...
    'reference_code' => 'PAINEL-COND-3CV-220V-TRI',
    ...
    'featured' => 0,
    'status' => 'published',
    'seo_title' => 'Painel Revezamento de Bombas 3CV 220V Trifásico',
    'seo_description' => 'Painel IP55 para revezamento automático de duas bombas de 3 CV em 220 V trifásico, com acionamento manual ou automático por boia.',
];
...
fwrite(STDOUT, "Produto de revezamento de bombas 3 CV 220 V atualizado.\n");
