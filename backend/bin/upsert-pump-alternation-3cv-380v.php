...
$pdo = Connection::get();
$slug = 'painel-condominio-revezamento-bombas-3cv-380v-trifasico';
$product = [
    'name' => 'Painel para Condomínio Revezamento de Bombas 3CV 380V Trifásico',
    'slug' => $slug,
    'summary' => 'Painel para alternância automática de duas bombas de 3 CV em 380 V trifásico, com operação manual ou automática e proteção individual dos motores.',
    'description' => "O Painel para Condomínio Revezamento de Bombas 3CV 380V Trifásico foi desenvolvido para o gerenciamento de sistemas de recalque em edifícios e condomínios. O quadro controla duas motobombas de forma alternada, distribui o tempo de funcionamento entre os equipamentos e mantém uma bomba reserva disponível para situações de falha.\n\nA lógica de controle permite o revezamento automático por ciclo de acionamento ou tempo. Caso a bomba em operação apresente uma anomalia elétrica ou mecânica, a unidade reserva pode assumir o funcionamento, contribuindo para a continuidade do abastecimento.\n\nO monitor de falta de fase e os relés térmicos individuais protegem os motores contra oscilações da rede e sobrecargas. Na porta do gabinete, indicadores luminosos apresentam o estado do comando, o funcionamento de cada motor e alertas de falha. As chaves seletoras oferecem os modos Manual, Desligado e Automático e a seleção do motor prioritário.\n\nO revezamento equilibra o desgaste de rolamentos e selos mecânicos, reduzindo o risco de travamento por falta de uso ou de danos por operação excessiva. O gabinete metálico reforçado recebe pintura eletrostática e vedação de borracha. A instalação e o manuseio devem ser realizados por profissional habilitado, conforme o projeto elétrico e as normas aplicáveis.",
    'features' => json_encode([
        'Produto: Painel de Comando para Revezamento de Bombas',
        'Potência suportada: 3 CV (2,2 kW) por motor',
        ...
        'Indicadores luminosos de funcionamento e alerta de falha',
    ...
    'benefits' => json_encode([
        ...
        'Proteção contra falta de fase, sobrecarga e oscilações da rede',
    ...
    'components' => json_encode([
        'Disjuntor tripolar',
        'Monitor de falta de fase para rede 380 V trifásica',
    ...
    'power_range' => '3 CV (2,2 kW) por motor',
    ...
    'reference_code' => 'PAINEL-COND-3CV-380V-TRI',
    'brand' => 'Painel de Comando',
    'model' => 'Painel para Condomínio Revezamento de Bombas 3CV',
    'price_cents' => 150800,
    'installments' => 3,
    ...
    'featured' => 0,
    'status' => 'published',
    'seo_title' => 'Painel Revezamento de Bombas 3CV 380V Trifásico',
    'seo_description' => 'Painel para revezamento automático de duas bombas de 3 CV em 380 V trifásico, com proteção individual e operação manual ou automática.',
];
...
fwrite(STDOUT, "Produto de revezamento de bombas 3 CV 380 V atualizado.\n");
