...
$pdo = Connection::get();
$slug = 'painel-condominio-revezamento-bombas-1cv-380v-trifasico';
$product = [
    'name' => 'Painel para Condomínio Revezamento de Bombas 1CV 380V Trifásico',
    'slug' => $slug,
    'summary' => 'Painel para alternância automática de duas bombas de 1 CV em 380 V trifásico, com operação manual ou automática e proteção individual dos motores.',
    'description' => "O Painel para Condomínio Revezamento de Bombas 1CV 380V Trifásico é a solução técnica para o gerenciamento de recalque em edifícios que operam com duas motobombas de baixa potência. O quadro automatiza a alternância entre os motores, distribuindo o tempo de funcionamento de forma equilibrada e ajudando a preservar rolamentos e selos mecânicos.\n\nA lógica de controle mantém o abastecimento hídrico contínuo e permite que a bomba reserva seja acionada quando a principal apresentar falha elétrica ou mecânica. O monitor de falta de fase e os relés térmicos individuais protegem os motores contra condições anormais da rede, quedas de tensão e sobrecargas.\n\nNa porta do gabinete, sinaleiros identificam comando ligado, funcionamento de cada motor e falha térmica. As chaves seletoras permitem escolher a operação Manual, Desligado ou Automático e selecionar o motor prioritário. O gabinete metálico reforçado recebe pintura eletrostática e vedação de borracha.\n\nIndicado para condomínios e edifícios com sistemas de recalque em 380 V, este painel oferece segurança operacional, alternância confiável e maior disponibilidade do abastecimento. A instalação e o manuseio devem ser realizados por profissional habilitado, conforme o projeto elétrico e as normas aplicáveis.",
    ...
    'reference_code' => 'PAINEL-COND-1CV-380V-TRI',
    ...
    'featured' => 0,
    'status' => 'published',
    'seo_title' => 'Painel Revezamento de Bombas 1CV 380V Trifásico',
    'seo_description' => 'Painel para revezamento automático de duas bombas de 1 CV em 380 V trifásico, com proteção térmica, falta de fase e operação manual ou automática.',
];
...
fwrite(STDOUT, "Produto de revezamento de bombas 1 CV 380 V atualizado.\n");
