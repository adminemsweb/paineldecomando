...
$pdo = Connection::get();
$slug = 'painel-condominio-revezamento-bombas-5cv-380v-trifasico';
$product = [
    'name' => 'Painel para Condomínio Revezamento de Bombas 5CV 380V Trifásico',
    'slug' => $slug,
    'summary' => 'Painel IP55 para alternância automática de duas bombas de 5 CV em 380 V trifásico, com acionamento manual ou automático por boia.',
    'description' => "O Painel para Condomínio Revezamento de Bombas 5CV 380V Trifásico foi projetado para controlar duas motobombas em ambientes de maior demanda, como condomínios, indústrias e clubes. O sistema distribui o tempo de funcionamento entre os motores e mantém uma bomba reserva disponível, contribuindo para um abastecimento contínuo.\n\nO acionamento pode ser realizado manualmente pela chave seletora de três posições ou automaticamente por sinal de boia. A alternância automática equilibra o uso das bombas, reduz o desgaste causado pela operação concentrada em uma única unidade e facilita o planejamento da manutenção.\n\nO painel utiliza proteções individuais contra sobrecarga e monitoramento de falta de fase. O gabinete metálico IP55 oferece proteção contra poeira e umidade, enquanto a sinalização frontal permite acompanhar o comando, o funcionamento de cada motor e alertas de falha.\n\nATENÇÃO: equipamento trifásico. As imagens são meramente ilustrativas; considere as especificações desta página. Os botões da porta e do quadro de comando são enviados desmontados para evitar avarias durante o transporte. O engate dos contatos utiliza flanges de encaixe rápido, permitindo montagem e remoção sem ferramentas, com simples aperto manual.\n\nInstalação e uso técnico: o equipamento deve ser instalado e manuseado por profissionais qualificados ou com conhecimento técnico adequado. Isso garante o pleno desempenho do produto e a segurança da aplicação. Dúvidas específicas de instalação devem ser direcionadas a um profissional habilitado da área elétrica.",
    ...
    'reference_code' => 'PAINEL-COND-5CV-380V-TRI',
    ...
    'featured' => 0,
    'status' => 'published',
    'seo_title' => 'Painel Revezamento de Bombas 5CV 380V Trifásico',
    'seo_description' => 'Painel IP55 para revezamento automático de duas bombas de 5 CV em 380 V trifásico, com acionamento manual ou automático por boia.',
];
...
fwrite(STDOUT, "Produto de revezamento de bombas 5 CV 380 V atualizado.\n");
