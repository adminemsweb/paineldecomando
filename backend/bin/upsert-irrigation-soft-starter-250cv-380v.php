...
$product = [
    ...
    'features' => json_encode([
        ...
        'Soft Starter SSW07 para motor de 250 CV em 380 V',
    ...
    'components' => json_encode([
        'Caixa metálica 80 × 60 × 30 cm',
        'Soft Starter SSW07 250 CV 380 V',
    ...
    'reference_code' => 'PAINEL-IRRI-SSW07-250CV-380V',
    ...
    'featured' => 0,
    'status' => 'published',
    'seo_title' => 'Painel para Irrigação Soft Starter SSW07 250CV 380V | Painel de Comando',
    'seo_description' => 'Painel de Comando para irrigação com Soft Starter SSW07, motor de até 250 CV em 380 V, IHM remota e proteção elétrica completa.',
];
...
fwrite(STDOUT, "Produto para irrigação 250 CV atualizado.\n");
