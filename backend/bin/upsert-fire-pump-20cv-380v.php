...
$product = [
    ...
    'reference_code' => 'PAINEL-20CV-380V-CAIXA-VERMELHA',
    'brand' => 'Painel de Comando',
    'model' => 'Painel Estrela Triângulo para Bomba de Incêndio 20CV 380V',
    'price_cents' => 217400,
    'installments' => 3,
    'stock_status' => 'on_demand',
    'stock_quantity' => 0,
    'lead_time' => 'Produção sob consulta',
    'sales_channel' => 'both',
    'warranty_days' => 365,
    'sort_order' => 22,
    'featured' => 1,
    'status' => 'published',
    'seo_title' => 'Painel para Bomba de Incêndio 20CV 380V | Painel de Comando',
    'seo_description' => 'Painel estrela-triângulo 20 CV 380 V para bomba de incêndio, com proteção IP54, comando manual e automático e parada de emergência.',
];
