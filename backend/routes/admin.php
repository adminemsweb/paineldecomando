...
$router->get('/api/v1/admin/categories', static fn(Request $request) => $adminCategories()->index($request));
$router->post('/api/v1/admin/categories', static fn(Request $request) => $adminCategories()->store($request));
